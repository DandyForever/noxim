...
public:
  ...
  // update the index of the reservation having highest priority in the current
  // cycle
  void updateIndex();
...
private:
  TRTEntry **rtable; // reservation vector: rtable[i] gives a RTEntry containing
                     // the set of input/VC which reserved output port
